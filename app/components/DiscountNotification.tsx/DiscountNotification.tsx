...
export default function DiscountNotification() {
    return (
        <div className="bg-primary-green p-3 lg:p-2 flex items-center justify-center gap-3 relative">
            ...
            <X className="absolute right-8 lg:right-5 w-4 lg:w-5 cursor-pointer" color="#121212" role="button" tabIndex={1} />
        </div>
    );
}